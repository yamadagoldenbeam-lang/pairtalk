...
const RELATIONSHIP_TYPES: {
  ...
  'bias_highSpeed_story': { 
    name: 'ガチ恋タイプ', 
    emoji: '💘', 
    description: '{user1}の想いが溢れて止まらない。情熱がトーク画面を埋め尽くす二人', 
  ...
  'bias_highSpeed_resonance': { 
    name: 'リア充全開タイプ', 
    emoji: '📸', 
    description: '{user1}のカメラロールは{user2}への共有フォルダ状態。日常ダダ漏れな二人', 
  ...
  'bias_highSpeed_peace': { 
    name: '構ってちゃん×塩対応タイプ', 
    emoji: '🧊', 
    description: '{user1}の連投に{user2}の「うん」。この温度差、逆に愛おしい二人', 
  ...
  'bias_leisurely_story': { 
    name: 'のんびりメンヘラケアタイプ', 
    emoji: '🤲', 
    description: '{user1}の本音を、{user2}が静かに受け止める。言葉で繋がる安全地帯な二人', 
  ...
  'bias_leisurely_peace': { 
    name: '聞き役×語り手タイプ', 
    emoji: '👂', 
    description: '{user1}が話す、{user2}が聞く。シンプルだけど心地いい、役割のハッキリした二人', 
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-[9999] md:hidden" style={{ WebkitTransform: 'translateZ(0)', position: 'fixed' }}>
        <div className="backdrop-blur-xl bg-white/98 border-b border-slate-200/80 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)]">
